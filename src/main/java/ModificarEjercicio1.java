 ...
 * @author HREF DIGITAL
 */
public class ModificarEjercicio1 extends javax.swing.JFrame {
    ...
    if (fila >= 0) {
        ...
        txtGrupoMuscular.setText(table.getValueAt(fila, 3).toString()); // Grupo muscular
    }
    ...
    if (fila >= 0) {
        try {
            ...
            String nuevaUrlImagen = rutaArchivoSeleccionado; // Asegúrate de que esté definido como variable de clase

            // Validación básica
            if (nuevoNombre.isEmpty() || nuevaDescripcion.isEmpty() || nuevoGrupoMuscular.isEmpty()) {
            ...
            cargarTabla(); // refresca la tabla después de la actualización
